...
export default function Dashboard() {
  ...
  const [career, setCareer] = useState("General Career");
    ...
    "Cloud Engineer": {
      recommendations: [
        ...
        },
        {
          ...
          description: "Understand containerization and deployment workflows.",
        },
        {
          title: "Kubernetes Fundamentals",
          description: "Manage scalable cloud-native applications.",
        },
      ],
      ...
      try {
        ...
        if (data?.career) {
          ...
          const selectedDomain =
            domainData[data.career] || domainData["General Career"];

          setRecommendations(selectedDomain.recommendations);
          setNextSteps(selectedDomain.nextSteps);
        }
      } catch (err) {
        console.error(err);
      }
      ...
      <div className={styles.dashboardContent}>
        ...
        <section className={styles.progressSection}>
          ...
          <div className={styles.progressCard}>
            ...
            <p>Keep learning consistently to improve your skills 🚀</p>
          </div>
        </section>
